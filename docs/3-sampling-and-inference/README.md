...
- [LPT mass mapping with MCLMC](16-LPT-MCLMC-MassMapping.ipynb) — the Euclid model of notebook 14 (2LPT spherical lightcone, two κ maps), sampled with MCLMC over the joint posterior of `(Ω_c, σ₈)` and the initial-condition field; posterior-predictive κ maps (mean, standard deviation, residual), their coherence and transfer function, and the starlet ℓ₁ norm against the truth.
