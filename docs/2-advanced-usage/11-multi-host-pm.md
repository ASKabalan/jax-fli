# 11 · Multi-host PM and validation against CosmoGrid
...
The runnable script is [`11-multi-host-pm.py`](11-multi-host-pm.py).
...
srun python 11-multi-host-pm.py --multihost \
...
XLA_FLAGS="--xla_force_host_platform_device_count=4" JAX_PLATFORMS=cpu \
    python 11-multi-host-pm.py --mesh 128 --nside 128 --nb-shells 8 --out kappa_sim.parquet
```

## Validating against CosmoGrid

`11-multi-host-pm.py` writes a `SphericalKappaField` catalog. We load it back, load a CosmoGrid
Stage-3 convergence reference (see [notebook 10](10-External-Catalog.ipynb)), and compare angular
...
# Our run (produced by 11-multi-host-pm.py, here at the same cosmology)
...
![Convergence power spectra: jax-fli multi-host PM vs CosmoGrid reference](11-multi-host-comparison.png)
