...
launch 64 4 256 1 00:35:00 -- $COMMON $PM --halo-multiplier 1.0 --sim-mode pm --lpt-order 2 --mesh-size $MESH_2560 --observer-position $OBS_FULL --box-size $BOX_FULL \
  --output "$RESULTS/exp10/pm_fs_2560" --name "exp10_pm_2560_s%seed%"
